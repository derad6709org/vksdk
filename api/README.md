...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/derad6709org/vksdk/v2/api)](https://pkg.go.dev/github.com/derad6709org/vksdk/v2/api)
...
[данной странице](https://pkg.go.dev/github.com/derad6709org/vksdk/v2/api?tab=doc#VK).
...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/derad6709org/vksdk/v2/api/params)](https://pkg.go.dev/github.com/derad6709org/vksdk/v2/api/params)

Модуль params предназначен для генерации параметров запроса.

```go
// import "github.com/derad6709org/vksdk/v2/api/params"
...
[отпишитесь сюда](https://github.com/derad6709org/vksdk/issues/180).
...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/derad6709org/vksdk/v2/errors)](https://pkg.go.dev/github.com/derad6709org/vksdk/v2/api#VK.Execute)
